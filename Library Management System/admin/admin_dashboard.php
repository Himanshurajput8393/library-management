	...
	<div class="row">
		...
		<div class="col-md-3"><br>
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					<p class="card-text">No. of Book Requests: <?php echo get_request_book_count();?></p>
					<a href="requested_book.php" class="btn btn-info" target="_blank">View books request</a>
				</div>
			</div>
		</div>
	</div>
